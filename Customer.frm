...
If Keyascii = 13 Then
    ...
    If CmdHapus.Enabled = True Then
        ...
        If Not RSCustomer.EOF Then
            ...
            If Pesan = vbYes Then
                hapus = "delete * from Customer where kodeCus='" & Text1 & "'"
                Conn.Execute hapus
                Call KondisiAwal
            Else
                Call KondisiAwal
...
RSCustomer.Requery
    ...
    With RSCustomer
        If .EOF Then
            ...
            Text1 = Urutan
        Else
            Hitung = Right(!KodeCus, 2) + 1
            Urutan = "C" + Right("00" & Hitung, 2)
        End If
        Text1 = Urutan
    End With
End Sub
...
Else
    If CmdInput.Enabled = True Then
        ...
        SQLTambah = "Insert Into Customer (KodeCus,NamaCus,AlamatCus,TeleponCus,PersonCus,emailCus) values " & _
        "('" & Text1 & "','" & Text2 & "','" & Text3 & "','" & Text4 & "','" & Text5 & "','" & Text6 & "')"
        Conn.Execute SQLTambah
    ElseIf CmdEdit.Enabled = True Then
        Dim SQLEdit As String
        SQLEdit = "Update Customer Set NamaCus= '" & Text2 & "', AlamatCus = '" & Text3 & "',TeleponCus = '" & Text4 & "',PersonCus = '" & Text5 & "',emailCus= '" & Text6 & "' where KodeCus='" & Text1 & "'"
...
Text2 = RSCustomer!NamaCus
Text3 = RSCustomer!alamatCus
Text4 = RSCustomer!TeleponCus
Text5 = RSCustomer!PersonCus
Text6 = RSCustomer!emailCus
End Sub
