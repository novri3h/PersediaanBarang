...
Else
    If CmdInput.Enabled = True Then
        ...
        SQLTambah = "Insert Into Supplier (KodeSpl,NamaSpl,AlamatSpl,TeleponSpl,PersonSpl,emailspl) values " & _
        "('" & Text1 & "','" & Text2 & "','" & Text3 & "','" & Text4 & "','" & Text5 & "','" & Text6 & "')"
        Conn.Execute SQLTambah
    ElseIf CmdEdit.Enabled = True Then
        Dim SQLEdit As String
        SQLEdit = "Update Supplier Set NamaSpl= '" & Text2 & "', AlamatSpl = '" & Text3 & "',TeleponSpl = '" & Text4 & "',PersonSpl = '" & Text5 & "',emailspl= '" & Text6 & "' where KodeSpl='" & Text1 & "'"
